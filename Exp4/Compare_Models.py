# This code samples from the MaMi dataset. It runs seeing double and compares the multifunctional capacity of
# different 300-neuron connectomes.

# For example, Baboon 5 vs baboon 4 are featured here.
import numpy as np
